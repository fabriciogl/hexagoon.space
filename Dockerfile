...
# OPTIONS e PORT serão passados pelo docker-compose em ambiente dev
...
# line of command for local development whithout docker-compose.yaml
# EXPOSE 8000
...
# call from terminal to add cloudsql instance
